...
@section('page_title') Все авторы @endsection
    ...
    <div class="col-12">
        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Все авторы</h3>
            </div>
                                            ...
                                            <tr class="{{ $loop->odd ? 'odd' : 'even' }}">
                                                ...
                                                <td>
                                                    <div class="table-action">
                                                        <a href="{{ route('admin.author.edit', ['id' => $author->id]) }}"  class="btn btn-block btn-outline-primary table-action__btn-edit"><i class="nav-icon fas fa-edit"></i></a>
                                                        <form action="{{ route('admin.author.delete') }}" class="delete-route" method="POST">
                                                            @CSRF
