                                            ...
                                            <tr class="{{ $loop->odd ? 'odd' : 'even' }}">
                                                ...
                                                <td>
                                                    <div class="table-action">
                                                        <a href="{{ route('admin.category.edit', ['id' => $category->id]) }}"  class="btn btn-block btn-outline-primary table-action__btn-edit"><i class="nav-icon fas fa-edit"></i></a>
                                                        <form action="{{ route('admin.category.delete') }}" class="delete-route" method="POST">
                                                            @CSRF
