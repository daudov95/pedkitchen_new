...
@section('page_title') Создание инструментария @endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card card-primary">
            ...
            <h3 class="card-title">Создание инструментария</h3>
            </div>

            
            <form method="POST" action="{{ route('admin.cookbook.diagnostic.store') }}" enctype="multipart/form-data">
                @CSRF
                <div class="card-body">
