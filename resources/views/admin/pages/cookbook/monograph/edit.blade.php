...
@section('page_title') Изменение монографа @endsection
...
<div class="row">
    <div class="col-12">
        ...
        <div class="card card-primary">
            ...
            <h3 class="card-title">Изменение монографа</h3>
            </div>

            
            <form method="POST" action="{{ route('admin.cookbook.monographs.update') }}" enctype="multipart/form-data">
                @CSRF
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="desc" class="form-control" rows="3" placeholder="Пишите...">{{ $post->desc }}</textarea>
                    </div>

                    <div class="form-group">
                        <label for="title">Год издания</label>
                        <input type="number" min="1950" class="form-control" id="year" name="year" value="{{ $post->year }}" placeholder="Введите год">
                    </div>
