                                            ...
                                            <tr class="{{ $loop->odd ? 'odd' : 'even' }}">
                                                ...
                                                <td>
                                                    <div class="table-action">
                                                        <a href="{{ route('admin.user.edit', ['id' => $user->id]) }}"  class="btn btn-block btn-outline-primary table-action__btn-edit"><i class="nav-icon fas fa-edit"></i></a>
                                                        <form action="{{ route('admin.user.delete') }}" class="delete-route" method="POST">
                                                            @CSRF
