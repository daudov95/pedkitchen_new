        ...
        <div class="subscribe__left">
            ...
            <form method="POST" action="{{ route('password.update') }}">
                ...
                <div class="subscribe-form">
                    ...
                    <input id="password" placeholder="Ваш пароль" type="password" class="subscribe-form__input form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                    ...
                    <input id="password-confirm" type="password" class="form-control" name="subscribe-form__input password_confirmation" required autocomplete="new-password">
